// Package vm is the backend-agnostic VM layer: the VM and VMBackend
// interfaces, install/run configuration, and disk-format types.
// Implementations live in vm/qemu and vm/vz.
package vm
...
// Implementations live in vm/qemu (QEMU) and vm/vz (macOS
