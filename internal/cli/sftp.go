...
// Empty (neither set) means no sharing; "." shares the current directory.
...
// embedded default flake (wslnix.DefaultFlakeNix). Values are either a local
// directory or a remote flake ref — wslnix.BuildTarball tells them apart.
